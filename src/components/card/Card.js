...
export default function CardProduk({ user }) {
    ...
    const getKategori = async () => {
        let response = await axios.get("https://secondhacktiv8-production.up.railway.app/v1/Produk/add/form")
        setKategori(response.data)
    }

    const getProducts = async () => {
        let response = await axios.get("https://secondhacktiv8-production.up.railway.app/v1/Produk");
    ...
    const kategori = async (id) => {
        let response = await axios.get(`https://secondhacktiv8-production.up.railway.app/v1/Produk/kategori/${id}`);
        let data = []
